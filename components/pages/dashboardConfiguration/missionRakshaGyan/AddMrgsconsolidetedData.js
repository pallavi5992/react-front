...
const AddMrgsconsolidetedData = () => {
  return (
    <div className="missioncontainer"style={{height:"80vh"}}>
...
export default AddMrgsconsolidetedData