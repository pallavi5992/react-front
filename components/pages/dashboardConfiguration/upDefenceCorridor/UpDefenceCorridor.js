      ...
      <div>
        ...
        >
          <li className="pull-left header">
            ...
            <strong>
              <h5><strong><i className="fa fa-inbox"></i>UP Defence Corridor List</strong></h5>
            </strong>
            {/* <hr/> */}
          </li>
        </ul>
        ...
        <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom text-center">
          ...
          <div className="row pull-right">
            <div className="col-md-12">
              <Link type="button" className="btn btn-primary m-1" to="/admin/index/addannouncedataup">
                <i className="fa fa-fw fa-user-plus"></i> Add Investment Announced Data
              </Link>
              <Link type="button" to="/admin/index/addupdefenceData" className="btn btn-primary">
...
export default UpDefenceCorridor
